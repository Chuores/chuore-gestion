...
export default function Sidebar() {
  ...
  return (
    <aside style={{ width: 'var(--sidebar-w)', minHeight: '100vh', background: 'var(--black)', display: 'flex', flexDirection: 'column', flexShrink: 0, borderRight: '1px solid rgba(255,255,255,0.06)' }}>
